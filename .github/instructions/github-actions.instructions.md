---
description: "Repository workflow contracts and permissions for dinesykmeldte-sidemeny"
applyTo: ".github/workflows/**"
---

# Workflow contract for dinesykmeldte-sidemeny

`.github/workflows/ci.yml` is the existing verification entry point.
`ci.yml` tests the library, `pages.yml` publishes the example and `release.yml` runs Changesets. Preserve these separate build and publication boundaries.
